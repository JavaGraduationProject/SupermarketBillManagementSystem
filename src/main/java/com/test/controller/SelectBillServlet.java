...
public class SelectBillServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 获得用户在浏览器中输入的注册信息
		String billProname = req.getParameter("billProname");
		String billPayment = req.getParameter("billPayment");
		...
		try {
			...
			List<Bill> list = service.selectBill(billProname,billPayment);
			...
			req.getRequestDispatcher("pages/admin_bill_list.jsp").forward(req, resp);
		} catch (Exception e) {
			e.printStackTrace();
